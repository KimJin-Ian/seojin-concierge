  ...
  return (
    <AdminShell>
      ...
      <div className="panel">
        ...
        <div className="field">
          <label>사이트 이름</label>
          <input type="text" defaultValue="The Wellness N" />
        </div>
        <div className="field">
          <label>도메인</label>
          <input type="text" defaultValue="https://thewellnessn.com" />
        </div>
        <div className="field">
          <label>대표 전화 (국제)</label>
          <input type="text" defaultValue="+82-10-2068-0817" />
        </div>
        <div className="field">
          <label>대표 이메일</label>
        ...
        <div className="field">
          <label>WhatsApp 채널 URL</label>
          <input type="url" defaultValue="https://whatsapp.com/channel/0029VbD3dlqGU3BBeU7sKN15" />
        </div>
      ...
      <div className="panel">
        ...
        <div className="field">
          ...
          <input type="text" defaultValue="The Wellness N — Korea Medical & K-Beauty Concierge" />
        </div>
        <div className="field">
          <label>설명 (Description)</label>
          <textarea defaultValue="강남 프리미엄 의료기관 협업 K-Beauty 컨시어지" rows={3} />
        </div>
        <button className="btn btn-primary" disabled>저장 (백엔드 연결 필요)</button>
      </div>
